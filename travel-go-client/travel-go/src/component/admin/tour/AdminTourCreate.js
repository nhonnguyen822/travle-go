...
const AdminTourCreateMultiStep = () => {
                ...
                activities: [
                    {
                        ...
                        title: "",
                        details: "",
                        imageFile: null, // upload file thực tế
                        imageUrl: "", // nếu có URL sẵn
                        position: 1,
                    },
                ],
            },
        ],
        services: [{ name: "", type: "INCLUDED" }],
        policies: [], // <-- để trống, lát nữa fetch API gán vào
    });
    ...
    const validationSchemas = [
        ...
        Yup.object({
            ...
            image: Yup.mixed()
                .required("Vui lòng chọn ảnh cover cho tour")
                .test("fileType", "Chỉ chấp nhận định dạng ảnh (jpg, jpeg, png, webp)", (value) => {
                    if (!value) return false;
                    return ["image/jpeg", "image/png", "image/jpg", "image/webp"].includes(value.type);
                })
                .test("fileSize", "Kích thước ảnh không được vượt quá 3MB", (value) => {
                    if (!value) return false;
            ...
            images: Yup.array()
                .of(
                    Yup.mixed()
                        ...
                        .test("fileSize", "Mỗi ảnh phụ không được vượt quá 3MB", (value) => {
                            if (!value) return false;
                            return value.size <= 3 * 1024 * 1024;
                        })
                )
                .min(1, "Vui lòng chọn ít nhất 1 ảnh phụ")
                ...
                .of(
                    Yup.object({
                        title: Yup.string()
                            ...
                            .max(200, "Tiêu đề ngày không được vượt quá 100 ký tự"),
                            ...
                            .of(
                                Yup.object({
                                    ...
                                    title: Yup.string()
                                        ...
                                        .max(100, "Tiêu đề hoạt động không vượt quá 100 ký tự"),
                                    details: Yup.string()
    ...
    const handleSubmit = async (values, {setSubmitting}) => {
        ...
        const toastId = toast.loading("⏳ Đang tạo tour...");
        ...
        try {
            ...
            // --- Chuẩn bị dữ liệu tour gửi server ---
            const tourData = {
                title: values.title,
                ...
                image: coverUrl,
                images: galleryUrls.map(url => ({ imageUrl: url })),
                itineraryDays,
            ...
            toast.error("❌ Có lỗi xảy ra khi tạo tour!", {id: toastId});
        } finally {
                    ...
                    <div className="max-w-6xl mx-auto bg-white shadow-lg rounded-2xl p-8">
                        ...
                        {isProcessing ? (
                            <div className="flex flex-col items-center justify-center py-20 text-gray-600">
                                ...
                                <p>Hệ thống đang tạo tour, bạn có thể làm việc khác...</p>
                            </div>
                        ) : (<Formik
                                        ...
                                        {step === 2 && (
                                            <div
                                                ...
                                                <div>
                                                    ...
                                                    {/* ✅ Hiển thị lỗi validate ảnh cover */}
                                                ...
                                                <div>
                                                    ...
                                                    <div
                                                        className="w-full border-2 border-dashed border-gray-200 rounded-2xl p-4 bg-white/40 transition-all duration-200">
                                                                ...
                                                                values.images?.map((file, idx) => (
                                                                    ...
                                                                    >
                                                                        ...
                                                                        <button
                                                                            type="button"
                                                                            onClick={() => {
                                                                                const newImgs = [...values.images];
                                                                                newImgs.splice(idx, 1);
                                                                                setFieldValue("images", newImgs);
                                                                            }}
                                        ...
                                        {day.activities?.length || 0} hoạt động
                                                                                                            ...
                                                                                                            <label className="block w-40 h-32 border-2 border-dashed border-gray-300 rounded-lg cursor-pointer hover:border-green-400 hover:bg-green-50 transition-all duration-200 overflow-hidden">
                                                                                                                {act.imageFile ? (
                                                                                                                    <div className="relative w-full h-full">
                                                                                                                        <img
                                                                                                                            src={URL.createObjectURL(act.imageFile)}
                                                                                                                            alt="activity"
                                                                                                                            className="w-full h-full object-cover"
                                                                                                                        />
                                                        ...
                                                        <div className="text-center">
                                                            {values.itineraryDays?.length < values.duration ? (
                                                                ...
                                                                >
                                                                    <PlusCircle size={18} />
                                                                    Thêm ngày mới ({values.itineraryDays?.length || 0}/{values.duration})
                                                                </button>
                                                            ) : (
...
export default AdminTourCreateMultiStep;